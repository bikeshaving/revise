    ...
    yield /* @__PURE__ */ createElement(CrankEditable, { state, onstatechange: () => this.refresh() }, /* @__PURE__ */ createElement(
      ...
      lines.map((line) => {
        ...
        if (match) {
          ...
          ), /* @__PURE__ */ createElement("span", { "data-content": "", style: { fontSize: 0 } }, "\u200B"), /* @__PURE__ */ createElement("span", { style: checked ? { textDecoration: "line-through", opacity: "0.5" } : void 0 }, match[2] || /* @__PURE__ */ createElement("br", null)));
        }
        return /* @__PURE__ */ createElement("div", { key }, line || /* @__PURE__ */ createElement("br", null));
      })
    ));
