import {
  Edit
} from "./chunk-OILSQ2Q2.js";
import {
  extractData
} from "./chunk-3JDYCM4J.js";
import {
  jsx
} from "./chunk-LVA7Z2UJ.js";
import "./chunk-LIR7K5JA.js";
import {
  __commonJS,
  __export,
  __toESM,
...
var require_acorn = __commonJS({
  "node_modules/acorn/dist/acorn.js"(exports, module) {
    ...
    (function(global2, factory) {
      ...
      var beforeExpr2 = { beforeExpr: true }, startsExpr3 = { startsExpr: true };
      var keywords2 = {};
      ...
      var types$12 = {
        num: new TokenType3("num", startsExpr3),
        regexp: new TokenType3("regexp", startsExpr3),
        string: new TokenType3("string", startsExpr3),
        name: new TokenType3("name", startsExpr3),
        privateId: new TokenType3("privateId", startsExpr3),
        ...
        backQuote: new TokenType3("`", startsExpr3),
        ...
        _function: kw2("function", startsExpr3),
        _if: kw2("if"),
        ...
        _this: kw2("this", startsExpr3),
        _super: kw2("super", startsExpr3),
        _class: kw2("class", startsExpr3),
        _extends: kw2("extends", beforeExpr2),
        _export: kw2("export"),
        _import: kw2("import", startsExpr3),
        _null: kw2("null", startsExpr3),
        _true: kw2("true", startsExpr3),
        _false: kw2("false", startsExpr3),
      ...
      function nextLineBreak2(code, from2, end) {
        if (end === void 0) end = code.length;
        for (var i2 = from2; i2 < end; i2++) {
          var next2 = code.charCodeAt(i2);
          if (isNewLine2(next2)) {
            return i2 < end - 1 && next2 === 13 && code.charCodeAt(i2 + 1) === 10 ? i2 + 2 : i2 + 1;
          }
        }
        return -1;
      }
      ...
      var BIND_NONE3 = 0, BIND_VAR3 = 1, BIND_LEXICAL3 = 2, BIND_FUNCTION3 = 3, BIND_SIMPLE_CATCH2 = 4, BIND_OUTSIDE3 = 5;
      ...
      pp$92.strictDirective = function(start) {
        ...
        for (; ; ) {
          skipWhiteSpace3.lastIndex = start;
          start += skipWhiteSpace3.exec(this.input)[0].length;
          var match2 = literal2.exec(this.input.slice(start));
          if (!match2) {
            return false;
          }
          if ((match2[1] || match2[2]) === "use strict") {
            skipWhiteSpace3.lastIndex = start + match2[0].length;
      ...
      var DestructuringErrors4 = function DestructuringErrors5() {
      ...
      pp$82.isLet = function(context) {
        ...
        var next2 = this.pos + skip[0].length, nextCh = this.fullCharCodeAt(next2);
        ...
        if (isIdentifierStart2(nextCh)) {
          var start = next2;
          do {
            next2 += nextCh <= 65535 ? 1 : 2;
          } while (isIdentifierChar2(nextCh = this.fullCharCodeAt(next2)));
          if (nextCh === 92) {
            return true;
          }
          var ident = this.input.slice(start, next2);
      ...
      pp$82.isAsyncFunction = function() {
        ...
        return !lineBreak2.test(this.input.slice(this.pos, next2)) && this.input.slice(next2, next2 + 8) === "function" && (next2 + 8 === this.input.length || !(isIdentifierChar2(after = this.fullCharCodeAt(next2 + 8)) || after === 92));
      };
      pp$82.isUsingKeyword = function(isAwaitUsing, isFor) {
        ...
        if (isAwaitUsing) {
          var usingEndPos = next2 + 5, after;
          if (this.input.slice(next2, usingEndPos) !== "using" || usingEndPos === this.input.length || isIdentifierChar2(after = this.fullCharCodeAt(usingEndPos)) || after === 92) {
            return false;
          }
          skipWhiteSpace3.lastIndex = usingEndPos;
          var skipAfterUsing = skipWhiteSpace3.exec(this.input);
          next2 = usingEndPos + skipAfterUsing[0].length;
          if (skipAfterUsing && lineBreak2.test(this.input.slice(usingEndPos, next2))) {
            return false;
          }
        }
        var ch = this.fullCharCodeAt(next2);
        ...
        do {
          next2 += ch <= 65535 ? 1 : 2;
        } while (isIdentifierChar2(ch = this.fullCharCodeAt(next2)));
        if (ch === 92) {
          return true;
        }
        var id = this.input.slice(idStart, next2);
      ...
      pp$82.parseForStatement = function(node2) {
        ...
        var refDestructuringErrors = new DestructuringErrors4();
      ...
      pp$82.parseForAfterInit = function(node2, init, awaitAt) {
      ...
      pp$82.parseFunctionStatement = function(node2, isAsync, declarationPosition) {
        this.next();
        return this.parseFunction(node2, FUNC_STATEMENT3 | (declarationPosition ? 0 : FUNC_HANGING_STATEMENT3), false, isAsync);
      };
      ...
      pp$82.parseCatchClauseParam = function() {
        ...
        this.checkLValPattern(param, simple ? BIND_SIMPLE_CATCH2 : BIND_LEXICAL3);
      ...
      pp$82.parseFunction = function(node2, statement, allowExpressionBody, isAsync, forInit) {
        ...
        if (this.options.ecmaVersion >= 9 || this.options.ecmaVersion >= 6 && !isAsync) {
          if (this.type === types$12.star && statement & FUNC_HANGING_STATEMENT3) {
            this.unexpected();
          }
        ...
        if (statement & FUNC_STATEMENT3) {
          node2.id = statement & FUNC_NULLABLE_ID3 && this.type !== types$12.name ? null : this.parseIdent();
          if (node2.id && !(statement & FUNC_HANGING_STATEMENT3)) {
            this.checkLValSimple(node2.id, this.strict || node2.generator || node2.async ? this.treatFunctionsAsVar ? BIND_VAR3 : BIND_LEXICAL3 : BIND_FUNCTION3);
          }
        }
        ...
        this.enterScope(functionFlags3(node2.async, node2.generator));
        if (!(statement & FUNC_STATEMENT3)) {
        ...
        return this.finishNode(node2, statement & FUNC_STATEMENT3 ? "FunctionDeclaration" : "FunctionExpression");
      };
      ...
      pp$82.parseClassElement = function(constructorAllowsSuper) {
        ...
        if (ecmaVersion2 < 13 || this.type === types$12.parenL || kind !== "method" || isGenerator || isAsync) {
          var isConstructor = !node2.static && checkKeyName3(node2, "constructor");
      ...
      pp$82.parseClassId = function(node2, isStatement) {
        if (this.type === types$12.name) {
          ...
          if (isStatement) {
            this.checkLValSimple(node2.id, BIND_LEXICAL3, false);
          }
        } else {
          if (isStatement === true) {
            this.unexpected();
      ...
      function isPrivateNameConflicted3(privateNameMap, element) {
      ...
      function checkKeyName3(node2, name) {
      ...
      pp$82.parseImportSpecifier = function() {
        ...
        this.checkLValSimple(node2.local, BIND_LEXICAL3);
      ...
      pp$72.checkLValSimple = function(expr, bindingType, checkClashes) {
        if (bindingType === void 0) bindingType = BIND_NONE3;
      ...
      pp$52.parseMaybeAssign = function(forInit, refDestructuringErrors, afterLeftParse) {
        ...
        if (refDestructuringErrors) {
          ...
          refDestructuringErrors = new DestructuringErrors4();
      ...
      pp$52.parseSubscript = function(base, startPos, startLoc, noCalls, maybeAsyncArrow, optionalChained, forInit) {
        ...
        if (computed || optional && this.type !== types$12.parenL && this.type !== types$12.backQuote || this.eat(types$12.dot)) {
          ...
          var refDestructuringErrors = new DestructuringErrors4(), oldYieldPos = this.yieldPos, oldAwaitPos = this.awaitPos, oldAwaitIdentPos = this.awaitIdentPos;
          this.yieldPos = 0;
          this.awaitPos = 0;
          this.awaitIdentPos = 0;
      ...
      pp$52.parseParenAndDistinguishExpression = function(canBeArrow, forInit) {
        ...
        if (this.options.ecmaVersion >= 6) {
          ...
          var refDestructuringErrors = new DestructuringErrors4(), oldYieldPos = this.yieldPos, oldAwaitPos = this.awaitPos, spreadStart;
          this.yieldPos = 0;
          this.awaitPos = 0;
      ...
      pp$52.parseMethod = function(isGenerator, isAsync, allowDirectSuper) {
        ...
        this.awaitPos = 0;
        this.awaitIdentPos = 0;
        this.enterScope(functionFlags3(isAsync, node2.generator) | SCOPE_SUPER2 | (allowDirectSuper ? SCOPE_DIRECT_SUPER2 : 0));
        this.expect(types$12.parenL);
        node2.params = this.parseBindingList(types$12.parenR, false, this.options.ecmaVersion >= 8);
        this.checkYieldAwaitInDefaultParams();
      ...
      pp$52.parseArrowExpression = function(node2, params, isAsync, forInit) {
        var oldYieldPos = this.yieldPos, oldAwaitPos = this.awaitPos, oldAwaitIdentPos = this.awaitIdentPos;
        this.enterScope(functionFlags3(isAsync, false) | SCOPE_ARROW2);
        this.initFunction(node2);
        if (this.options.ecmaVersion >= 8) {
          node2.async = !!isAsync;
        }
      ...
      pp$52.parseFunctionBody = function(node2, isArrowFunction, isMethod, forInit) {
        ...
        if (isExpression) {
          ...
          if (this.strict && node2.id) {
            this.checkLValSimple(node2.id, BIND_OUTSIDE3);
          }
      ...
      RegExpValidationState3.prototype.nextIndex = function nextIndex2(i2, forceU) {
        ...
        var c = s.charCodeAt(i2), next2;
        if (!(forceU || this.switchU) || c <= 55295 || c >= 57344 || i2 + 1 >= l || (next2 = s.charCodeAt(i2 + 1)) < 56320 || next2 > 57343) {
          return i2 + 1;
        }
        return i2 + 2;
      };
      ...
      pp2.fullCharCodeAt = function(pos) {
        ...
        var next2 = this.input.charCodeAt(pos + 1);
...
var require_acorn_jsx = __commonJS({
  "node_modules/acorn-jsx/index.js"(exports, module) {
    ...
    var hexNumber2 = /^[\da-fA-F]+$/;
    var decimalNumber2 = /^\d+$/;
          ...
          while (this.pos < this.input.length && count++ < 10) {
            ...
            if (ch === ";") {
              if (str[0] === "#") {
                if (str[1] === "x") {
                  str = str.substr(2);
                  if (hexNumber2.test(str))
                    entity = String.fromCharCode(parseInt(str, 16));
                } else {
                  str = str.substr(1);
                  if (decimalNumber2.test(str))
...
function createChildrenByKey(children, offset2) {
  const childrenByKey = /* @__PURE__ */ new Map();
  for (let i = offset2; i < children.length; i++) {
...
function commitHost(adapter, ret, ctx, root, schedulePromises, hydrationNodes) {
  ...
  if (!copyChildren) {
    const children = commitChildren(adapter, ret, ctx, scope, tag === Portal ? node2 : root, ret, 0, schedulePromises, hydrationMetaProp && !hydrationMetaProp.includes("children") ? void 0 : childHydrationNodes);
    adapter.arrange({
      tag,
      tagName: getTagName(tag),
      node: node2,
...
function contextContains(parent, child) {
  for (let current2 = child; current2 !== void 0; current2 = current2.parent) {
    if (current2 === parent) {
      return true;
    }
  }
...
var ANONYMOUS_ROOT = {};
function flush2(adapter, root, initiator) {
  if (root != null) {
...
function isRetainerActive(target, host) {
  ...
  while (stack.length > 0) {
    ...
    const isHostBoundary = current2 !== host && (typeof current2.el.tag === "string" && current2.el.tag !== Fragment || current2.el.tag === Portal);
    if (current2.children && !isHostBoundary) {
      if (Array.isArray(current2.children)) {
    ...
    if (current2.fallback && !getFlag(current2, DidDiff)) {
      stack.push(current2.fallback);
    }
  }
  return false;
}
function propagateComponent(ctx) {
  ...
  flush2(ctx.adapter, ctx.root, ctx);
}
...
// ../packages/crankeditable/node_modules/@b9g/revise/src/_chunks/chunk-CETUMGXV.js
init_Buffer();
init_process();
...
function clear(subseq) {
  const { length: length2 } = measure(subseq);
  return length2 ? [length2] : [];
}
function fill(subseq) {
  const { length: length2 } = measure(subseq);
  return length2 ? [0, length2] : [];
}
...
var Edit2 = class _Edit {
  ...
  operations() {
    ...
    for (let i = 0; i < this.parts.length - 1; i += 3) {
      ...
      currentPos = position2 + deleted.length;
    }
  ...
  normalize() {
        ...
        case "delete": {
          ...
          if (insertion !== void 0) {
            if (insertion === deletion) {
              ...
              const insertionRemainder = insertion.slice(prefix2);
              const deletionRemainder = deletion.slice(prefix2);
    ...
    for (let i = 0; i < result.parts.length - 1; i += 3) {
      const position2 = result.parts[i];
      ...
      if (deleted2 && inserted2) {
        ...
        if (prefixLen > 0 || suffixLen > 0) {
          ...
          const optimizedPosition = position2 + prefixLen;
          ...
          compactedParts.push(position2, deleted2, inserted2);
        }
      } else {
        compactedParts.push(position2, deleted2, inserted2);
      }
  ...
  static builder(value = "") {
    ...
    return {
      ...
      delete(length2) {
        if (value != null && value !== "") {
          length2 = Math.min(value.length - index, length2);
          deleted += value.slice(index, index + length2);
        }
        index += length2;
        pushSegment(insertSeq, length2, false);
...
function synthesize(insertSeq, inserted, deleteSeq, deleted) {
  ...
  for (const [length2, deleting, inserting] of align(
    expandedDeleteSeq,
    insertSeq
  )) {
    if (deleting || inserting) {
      const deletedText = deleting ? deleted.slice(deleteIndex, deleteIndex + length2) : "";
      const insertedText = inserting ? inserted.slice(insertIndex, insertIndex + length2) : "";
      if (pendingPos >= 0 && position2 === pendingPos + pendingDeleted.length) {
        pendingDeleted += deletedText;
        pendingInserted += insertedText;
      } else {
        flushPending();
        pendingPos = position2;
        pendingDeleted = deletedText;
        pendingInserted = insertedText;
      }
      if (deleting) {
...
function validateEditParts(parts) {
  ...
  for (let i = 0; i < parts.length - 1; i += 3) {
    const position2 = parts[i];
    const deleted = parts[i + 1];
    const inserted = parts[i + 2];
    if (typeof position2 !== "number") {
      throw new Error(
        `Position at index ${i} must be a number, got ${typeof position2}`
      );
    }
    ...
    if (position2 < 0) {
      throw new Error(`Position ${position2} at index ${i} cannot be negative`);
    }
    if (position2 <= previousPos) {
      throw new Error(
        `Position ${position2} at index ${i} must be > previous end position ${previousPos}`
      );
    }
    const deletionEnd = position2 + deleted.length;
    const nextIndex2 = i + 3;
    if (nextIndex2 < parts.length - 1) {
      const nextPos = parts[nextIndex2];
      if (deletionEnd > nextPos) {
        throw new Error(
          `Deletion at position ${position2} extends to ${deletionEnd}, exceeding next position ${nextPos}`
        );
      }
    } else {
      if (deletionEnd > finalPos) {
        throw new Error(
          `Deletion at position ${position2} extends to ${deletionEnd}, exceeding final position ${finalPos}`
        );
      }
    }
...
var ContentAreaElement = class extends HTMLElement {
  ...
  indexAt(node2, offset2) {
    validate(this);
    return indexAt(this, node2, offset2);
  }
  nodeOffsetAt(index) {
    validate(this);
...
function invalidate(_this, records) {
  ...
  for (let i = 0; i < records.length; i++) {
    ...
    for (let j = 0; j < record.addedNodes.length; j++) {
      ...
      clear2(addedNode, cache2);
    }
    for (let j = 0; j < record.removedNodes.length; j++) {
      clear2(record.removedNodes[j], cache2);
    }
    ...
    for (; node2 !== _this; node2 = node2.parentNode) {
      ...
      const nodeInfo = cache2.get(node2);
      if (nodeInfo) {
        nodeInfo.f &= ~IS_VALID;
      }
      invalid = true;
  ...
  if (invalid) {
    const nodeInfo = cache2.get(_this);
    nodeInfo.f &= ~IS_VALID;
  }
  return invalid;
}
function clear2(parent, cache2) {
...
function diff(_this, oldValue, oldSelectionStart) {
  ...
  let nodeInfo;
  let value = "";
  for (let node2 = _this, descending = true, offset2 = 0, oldIndex = 0, oldIndexRelative = 0, hasNewline = false; ; node2 = walker.currentNode) {
    if (descending) {
      nodeInfo = cache2.get(node2);
      if (nodeInfo === void 0) {
        cache2.set(node2, nodeInfo = new NodeInfo(0));
        if (isBlocklikeElement(node2)) {
          nodeInfo.f |= IS_BLOCKLIKE;
        }
      }
      if (offset2 && !hasNewline && nodeInfo.f & IS_BLOCKLIKE) {
        hasNewline = true;
        offset2 += NEWLINE.length;
        value += NEWLINE;
      ...
      if (nodeInfo.f & IS_VALID) {
      ...
      } else if (node2 !== _this && node2.hasAttribute("data-content")) {
        ...
        const beforeText = node2 !== _this ? ((_a = node2.getAttribute) == null ? void 0 : _a.call(node2, "data-contentbefore")) || "" : "";
      ...
      offset2 = nodeInfo.offset + offset2;
    }
    if (!descending) {
      if (!(nodeInfo.f & IS_VALID)) {
        if (node2 !== _this && node2.nodeType === Node.ELEMENT_NODE && node2.nodeName !== "BR" && !node2.hasAttribute("data-content")) {
          const afterText = node2.getAttribute("data-contentafter") || "";
          if (afterText.length) {
            value += afterText;
            offset2 += afterText.length;
        ...
        if (nodeInfo.f & APPENDS_NEWLINE && node2.nodeType === Node.ELEMENT_NODE && !node2.hasAttribute("data-content")) {
          oldIndex += NEWLINE.length;
        }
        ...
        nodeInfo.length = offset2 - nodeInfo.offset;
        nodeInfo.f |= IS_VALID;
      }
      nodeInfo.f |= IS_OLD;
...
function indexAt(_this, node2, offset2) {
  const cache2 = _this[_cache];
  ...
  if (node2.nodeType === Node.TEXT_NODE) {
    const nodeInfo = cache2.get(node2);
    index = offset2 + nodeInfo.offset;
    node2 = node2.parentNode;
  } else {
    if (offset2 <= 0) {
      index = 0;
    } else if (offset2 >= node2.childNodes.length) {
      const nodeInfo = cache2.get(node2);
      ...
      let child = node2.childNodes[offset2];
      while (child !== null && !cache2.has(child)) {
...
function nodeOffsetAt(_this, index) {
  ...
  const [node2, offset2] = findNodeOffset(_this, index);
...
function findNodeOffset(_this, index) {
  ...
  for (let node22 = _this; node22 !== null; ) {
    const nodeInfo = cache2.get(node22);
    if (nodeInfo == null) {
      return nodeOffsetFromChild(node22, index > 0);
    }
    if (nodeInfo.f & PREPENDS_NEWLINE) {
      index -= 1;
    }
    if (index === nodeInfo.length && node22.nodeType === Node.TEXT_NODE) {
      return [node22, node22.data.length];
    } else if (index >= nodeInfo.length) {
      index -= nodeInfo.length;
      const nextSibling = walker.nextSibling();
      if (nextSibling === null) {
        if (node22 === _this) {
          return [node22, getNodeLength(node22)];
        }
        return nodeOffsetFromChild(walker.currentNode, true);
      }
      node22 = nextSibling;
    } else {
      if (node22.nodeType === Node.ELEMENT_NODE) {
        if (node22.hasAttribute("data-content")) {
          return nodeOffsetFromChild(node22, index > 0);
        }
        const ni = cache2.get(node22);
      ...
      if (firstChild === null) {
        const offset2 = node22.nodeType === Node.TEXT_NODE ? index : Math.min(index > 0 ? 1 : 0, getNodeLength(node22));
        return [node22, offset2];
      } else {
        node22 = firstChild;
      }
    }
...
function nodeOffsetFromChild(node2, after = false) {
  ...
  let offset2 = Array.from(parentNode.childNodes).indexOf(node2);
  if (after) {
    offset2++;
  }
  return [parentNode, offset2];
}
...
function setSelectionRange(_this, { start, end, direction }) {
  ...
  if (focus === anchor) {
    const [node2, offset2] = nodeOffsetAt(_this, focus);
    selection.collapse(node2, offset2);
  } else {
...
var EditableState = class {
  ...
  setValue(newValue, options) {
    const edit = Edit2.diff(this.#value, newValue);
...
function* CodeEditor({
  ...
  this.addEventListener("keydown", (ev) => {
    if (!editable) return;
    if (ev.key === "Enter") {
      const area = ev.target.closest("content-area");
      if (!area) return;
      ...
      const edit = Edit.builder(state.value).retain(selectionStart).insert(insert).retain(state.value.length - selectionStart).build();
      state.applyEdit(edit);
      this.refresh();
...
pp$8.isLet = function(context) {
  ...
  if (isIdentifierStart(nextCh)) {
    ...
    do {
      next2 += nextCh <= 65535 ? 1 : 2;
    } while (isIdentifierChar(nextCh = this.fullCharCodeAt(next2)));
    if (nextCh === 92) {
      return true;
    }
    var ident = this.input.slice(start, next2);
...
pp$8.isAsyncFunction = function() {
  ...
  var skip = skipWhiteSpace.exec(this.input);
  var next2 = this.pos + skip[0].length, after;
  return !lineBreak.test(this.input.slice(this.pos, next2)) && this.input.slice(next2, next2 + 8) === "function" && (next2 + 8 === this.input.length || !(isIdentifierChar(after = this.fullCharCodeAt(next2 + 8)) || after === 92));
};
pp$8.isUsingKeyword = function(isAwaitUsing, isFor) {
  ...
  if (isAwaitUsing) {
    var usingEndPos = next2 + 5, after;
    if (this.input.slice(next2, usingEndPos) !== "using" || usingEndPos === this.input.length || isIdentifierChar(after = this.fullCharCodeAt(usingEndPos)) || after === 92) {
      return false;
    }
    skipWhiteSpace.lastIndex = usingEndPos;
    var skipAfterUsing = skipWhiteSpace.exec(this.input);
    next2 = usingEndPos + skipAfterUsing[0].length;
    if (skipAfterUsing && lineBreak.test(this.input.slice(usingEndPos, next2))) {
      return false;
    }
  }
  var ch = this.fullCharCodeAt(next2);
  ...
  do {
    next2 += ch <= 65535 ? 1 : 2;
  } while (isIdentifierChar(ch = this.fullCharCodeAt(next2)));
  if (ch === 92) {
    return true;
  }
  var id = this.input.slice(idStart, next2);
...
function generateAcornTypeScript(_acorn) {
  ...
  if (!acornTypeScript) {
    let tokenIsLiteralPropertyName = function(token2) {
      return token2 === types$1.name || token2 === types$1.string || token2 === types$1.num || keywordTypeValues.includes(token2) || tsKwTokenTypeValues.includes(token2);
    }, tokenIsKeywordOrIdentifier = function(token2) {
      return token2 === types$1.name || keywordTypeValues.includes(token2) || tsKwTokenTypeValues.includes(token2);
    }, tokenIsIdentifier = function(token2) {
      return token2 === types$1.name || tsKwTokenTypeValues.includes(token2);
    }, tokenIsTSDeclarationStart = function(token2) {
      return token2 === tsKwTokenType.abstract || token2 === tsKwTokenType.declare || token2 === tsKwTokenType.enum || token2 === tsKwTokenType.module || token2 === tsKwTokenType.namespace || token2 === tsKwTokenType.interface || token2 === tsKwTokenType.type;
    }, tokenIsTSTypeOperator = function(token2) {
      return token2 === tsKwTokenType.keyof || token2 === tsKwTokenType.readonly || token2 === tsKwTokenType.unique;
    }, tokenIsTemplate = function(token2) {
      return token2 === types$1.invalidTemplate;
    };
...
var TypeScriptError = {
  ...
  EmptyHeritageClauseType: ({ token: token2 }) => `'${token2}' list cannot be empty.`,
...
function generateJsxParser(acorn, acornTypeScript, Parser3, jsxOptions) {
  ...
  return class JsxParser extends Parser3 {
    ...
    jsx_parseIdentifier() {
      let node2 = this.startNode();
      if (this.type === tok.jsxName) node2.name = this.value;
      else if (this.type.keyword) node2.name = this.type.keyword;
  ...
  return class ImportAttributes extends Parse {
    ...
    parseWithEntries() {
      ...
      do {
        ...
        this.next();
        node2.key = withionKeyNode;
        if (attrNames.has(node2.key.name)) {
...
function tokenCanStartExpression(token2) {
  return Boolean(token2.startsExpr);
}
function nonNull(x) {
  if (x == null) {
...
function tsPlugin(options) {
  ...
  return function(Parser3) {
    ...
    function nextLineBreak2(code, from2, end = code.length) {
    ...
    class TypeScriptParser2 extends Parser3 {
      constructor(options2, input, startPos) {
        ...
        this.tsParseConstModifier = (node2) => {
      ...
      finishNode(node2, type) {
        ...
        return super.finishNode(node2, type);
      }
      ...
      resetEndLocation(node2, endPos = this.lastTokEnd, endLoc = this.lastTokEndLoc) {
        node2.end = endPos;
        node2.loc.end = endLoc;
        if (this.options.ranges) node2.range[1] = endPos;
      }
      ...
      tsCheckForInvalidTypeCasts(items) {
        items.forEach((node2) => {
          if ((node2 == null ? void 0 : node2.type) === "TSTypeCastExpression") {
            this.raise(node2.typeAnnotation.start, TypeScriptError.UnexpectedTypeAnnotation);
          }
        });
      }
       ...
       * @returns {boolean}
       * */
      ts_type_isContextual(type, token2) {
        return type === token2 && !this.containsEsc;
      }
      /**
       * ts isContextual
       * @param {TokenType} token
       * @returns {boolean}
       * */
      ts_isContextual(token2) {
        return this.type === token2 && !this.containsEsc;
      }
      ts_isContextualWithState(state, token2) {
        return state.type === token2 && !state.containsEsc;
      }
      ...
      tsParseThisTypePredicate(lhs) {
        ...
        node2.typeAnnotation = this.tsParseTypeAnnotation(
          /* eatColon */
          false
        );
        node2.asserts = false;
      ...
      tsCheckTypeAnnotationForReadOnly(node2) {
        switch (node2.typeAnnotation.type) {
          ...
          case "TSArrayType":
            return;
          default:
            this.raise(node2.start, TypeScriptError.UnexpectedReadonly);
        }
      }
      tsParseTypeOperator() {
        const node2 = this.startNode();
      ...
      tsParseImportType() {
        ...
        if (this.tsMatchLeftRelational()) {
          node2.typeArguments = this.tsParseTypeArguments();
        }
      ...
      tsParseTemplateLiteralType() {
        const node2 = this.startNode();
        node2.literal = this.parseTemplate({ isTagged: false });
        return this.finishNode(node2, "TSLiteralType");
      }
      ...
      tsParseHeritageClause(token2) {
        ...
        if (!delimitedList.length) {
          this.raise(originalStart, TypeScriptError.EmptyHeritageClauseType({ token: token2 }));
        }
      ...
      tsParseInterfaceDeclaration(node2, properties = {}) {
        ...
        if (tokenIsIdentifier(this.type)) {
          node2.id = this.parseIdent();
          this.checkLValSimple(node2.id, acornScope.BIND_TS_INTERFACE);
        } else {
          node2.id = null;
      ...
      tsParseTypeAliasDeclaration(node2) {
        node2.id = this.parseIdent();
        this.checkLValSimple(node2.id, acornScope.BIND_TS_TYPE);
      ...
      parseFunction(node2, statement, allowExpressionBody, isAsync, forInit) {
        ...
        if (statement & FUNC_STATEMENT2) {
          node2.id = statement & FUNC_NULLABLE_ID2 && this.type !== tt.name ? null : this.parseIdent();
        }
        ...
        this.awaitPos = oldAwaitPos;
        this.awaitIdentPos = oldAwaitIdentPos;
        if (statement & FUNC_STATEMENT2 && node2.id && !(statement & FUNC_HANGING_STATEMENT2)) {
          if (node2.body) {
            this.checkLValSimple(
              node2.id,
              this.strict || node2.generator || node2.async ? this.treatFunctionsAsVar ? acornScope.BIND_VAR : acornScope.BIND_LEXICAL : acornScope.BIND_FUNCTION
            );
          } else {
            this.checkLValSimple(node2.id, acornScope.BIND_NONE);
          }
        }
        this.maybeInArrowParameters = oldMaybeInArrowParameters;
      ...
      parseFunctionBody(node2, isArrowFunction = false, isMethod = false, forInit = false, tsConfig) {
        ...
        if (bodilessType === "TSDeclareFunction" && this.isAmbientContext) {
          this.raise(node2.start, TypeScriptError.DeclareFunctionHasImplementation);
          if (node2.declare) {
            super.parseFunctionBody(node2, isArrowFunction, isMethod, false);
            return this.finishNode(node2, bodilessType);
          }
        }
        super.parseFunctionBody(node2, isArrowFunction, isMethod, forInit);
        return node2;
      }
      parseNew() {
        var _a;
      ...
      parseExprOp(left, leftStartPos, leftStartLoc, minPrec, forInit) {
        if (tt._in.binop > minPrec && !this.hasPrecedingLineBreak()) {
          ...
          if (nodeType) {
            ...
            this.finishNode(node2, nodeType);
            this.reScan_lt_gt();
            return this.parseExprOp(node2, leftStartPos, leftStartLoc, minPrec, forInit);
          }
        }
      ...
      parseImport(node2) {
        ...
        this.semicolon();
        this.finishNode(node2, "ImportDeclaration");
        this.importOrExportOuterKind = "value";
        if (node2.importKind === "type" && node2.specifiers.length > 1 && node2.specifiers[0].type === "ImportDefaultSpecifier") {
          this.raise(node2.start, TypeScriptError.TypeImportCannotSpecifyDefaultAndNamed);
        }
        return node2;
      }
      ...
      parseExportAllDeclaration(node2, exports) {
      ...
      parseExport(node2, exports) {
        ...
        if (this.ts_eatWithState(tt._import, 2, enterHead)) {
          ...
          const assign2 = node2;
          assign2.expression = this.parseExpression();
          this.semicolon();
          this.importOrExportOuterKind = void 0;
          ...
          if (this.shouldParseExportStatement()) {
            ...
            if (node2.declaration.type === "VariableDeclaration")
              this.checkVariableExport(exports, node2.declaration.declarations);
            else this.checkExport(exports, node2.declaration.id, node2.declaration.id.start);
            node2.specifiers = [];
            node2.source = null;
          } else {
            node2.declaration = null;
            ...
            if (this.eatContextual("from")) {
              ...
              for (let spec of node2.specifiers) {
                this.checkUnreserved(spec.local);
                this.checkLocalExport(spec.local);
                if (spec.local.type === "Literal") {
                  this.raise(
      ...
      parseMaybeDefault(startPos, startLoc, left) {
        ...
        if (node2.type === "AssignmentPattern" && node2.typeAnnotation && node2.right.start < node2.typeAnnotation.start) {
          this.raise(node2.typeAnnotation.start, TypeScriptError.TypeAnnotationAfterAssign);
        }
        return node2;
      }
      typeCastToParameter(node2) {
        ...
        this.resetEndLocation(
          node2.expression,
          node2.typeAnnotation.end,
          (_a = node2.typeAnnotation.loc) == null ? void 0 : _a.end
        );
      ...
      reportReservedArrowTypeParam(node2) {
        var _a;
        if (node2.params.length === 1 && !((_a = node2.extra) == null ? void 0 : _a.trailingComma) && disallowAmbiguousJSXLike) {
          this.raise(node2.start, TypeScriptError.ReservedArrowTypeParam);
        }
      }
      ...
      parseVarStatement(node2, kind, allowMissingInitializer = false) {
        ...
        this.next();
        super.parseVar(node2, false, kind, allowMissingInitializer || isAmbientContext);
        this.semicolon();
        const declaration2 = this.finishNode(node2, "VariableDeclaration");
        if (!isAmbientContext) return declaration2;
        for (const { id, init } of declaration2.declarations) {
          if (!init) continue;
      ...
      parseClassElement(constructorAllowsSuper) {
        ...
        const callParseClassMemberWithIsStatic = () => {
          if (this.tsIsStartOfStaticBlocks()) {
            ...
            if (idx) {
              if (node2.abstract) {
                this.raise(node2.start, TypeScriptError.IndexSignatureHasAbstract);
              }
              ...
              if (node2.declare) {
                this.raise(node2.start, TypeScriptError.IndexSignatureHasDeclare);
              }
              if (node2.override) {
                this.raise(node2.start, TypeScriptError.IndexSignatureHasOverride);
              }
              return idx;
            }
            if (!this.inAbstractClass && node2.abstract) {
              this.raise(node2.start, TypeScriptError.NonAbstractClassHasAbstractMethod);
            }
            if (node2.override) {
              if (!constructorAllowsSuper) {
                this.raise(node2.start, TypeScriptError.OverrideNotInSubClass);
              }
            }
            node2.static = isStatic;
            if (isStatic) {
            ...
            if (this.isClassMethod() || this.ecmaVersion < 13 || this.type === tt.parenL || kind !== "method" || isGenerator || isAsync) {
              const isConstructor = !node2.static && checkKeyName2(node2, "constructor");
      ...
      parseArrowExpression(node2, params, isAsync, forInit) {
        ...
        this.initFunction(node2);
        const oldMaybeInArrowParameters = this.maybeInArrowParameters;
        if (this.ecmaVersion >= 8) node2.async = !!isAsync;
        this.yieldPos = 0;
        this.awaitPos = 0;
        this.awaitIdentPos = 0;
        this.maybeInArrowParameters = true;
      ...
      parseMaybeAssign(forInit, refExpressionErrors, afterLeftParse) {
        ...
        if (!(jsx3 == null ? void 0 : jsx3.error) && !this.tsMatchLeftRelational()) {
        ...
        if (jsx3 == null ? void 0 : jsx3.node) {
          this.setLookaheadState(jsx3.failState);
          return jsx3.node;
        }
        if (arrow.node) {
        ...
        if (jsx3 == null ? void 0 : jsx3.thrown) throw jsx3.error;
        if (arrow.thrown) throw arrow.error;
        if (typeCast == null ? void 0 : typeCast.thrown) throw typeCast.error;
        throw (jsx3 == null ? void 0 : jsx3.error) || arrow.error || (typeCast == null ? void 0 : typeCast.error);
      }
      ...
      toAssignable(node2, isBinding = false, refDestructuringErrors = new DestructuringErrors3()) {
        switch (node2.type) {
          case "ParenthesizedExpression":
          ...
          case "TSTypeAssertion":
            if (isBinding) {
              ...
              this.raise(node2.start, TypeScriptError.UnexpectedTypeCastInParameter);
            }
            return this.toAssignable(node2.expression, isBinding, refDestructuringErrors);
          case "MemberExpression":
            break;
          case "AssignmentExpression":
            if (!isBinding && node2.left.type === "TSTypeCastExpression") {
              node2.left = this.typeCastToParameter(node2.left);
            }
            return super.toAssignable(node2, isBinding, refDestructuringErrors);
          case "TSTypeCastExpression": {
            return this.typeCastToParameter(node2);
          }
          default:
            return super.toAssignable(node2, isBinding, refDestructuringErrors);
        }
      ...
      toAssignableParenthesizedExpression(node2, isBinding, refDestructuringErrors) {
      ...
      parseParenArrowList(startPos, startLoc, exprList, forInit) {
        const node2 = this.startNodeAt(startPos, startLoc);
        node2.returnType = this.shouldParseArrowReturnType;
        this.shouldParseArrowReturnType = void 0;
        return this.parseArrowExpression(node2, exprList, false, forInit);
      }
      ...
      parseTaggedTemplateExpression(base, startPos, startLoc, optionalChainMember) {
        const node2 = this.startNodeAt(startPos, startLoc);
        node2.tag = base;
        node2.quasi = this.parseTemplate({ isTagged: true });
      ...
      parseSubscript(base, startPos, startLoc, noCalls, maybeAsyncArrow, optionalChained, forInit) {
        ...
        if (this.tsMatchLeftRelational() || this.match(tt.bitShift)) {
          ...
          const result = this.tsTryParseAndCatch(() => {
            ...
            if (!noCalls && this.eat(tt.parenL)) {
              ...
              this.tsCheckForInvalidTypeCasts(node22.arguments);
              node22.typeArguments = typeArguments;
              if (_optionalChained) {
                node22.optional = isOptionalCall;
              }
              this.checkExpressionErrors(refDestructuringErrors, true);
              base = this.finishNode(node22, "CallExpression");
              return base;
            }
        ...
        if (computed || optional && this.type !== tt.parenL && this.type !== tt.backQuote || this.eat(tt.dot)) {
          ...
          node2.tag = base;
          node2.quasi = this.parseTemplate({ isTagged: true });
          base = this.finishNode(node2, "TaggedTemplateExpression");
        }
        return base;
      }
      ...
      parseClass(node2, isStatement) {
        ...
        this.inAbstractClass = !!node2.abstract;
        try {
          this.next();
          ...
          while (this.type !== tt.braceR) {
            ...
            const element = this.parseClassElement(node2.superClass !== null);
            if (decorators.length) {
            ...
            if (element) {
              ...
              } else if (element.key && element.key.type === "PrivateIdentifier" && ((_a = element.value) == null ? void 0 : _a.type) !== "TSDeclareMethod" && isPrivateNameConflicted2(privateNameMap, element)) {
                this.raiseRecoverable(
                  element.key.start,
      ...
      parseMethod(isGenerator, isAsync, allowDirectSuper, inClassScope, method) {
        let node2 = this.startNode(), oldYieldPos = this.yieldPos, oldAwaitPos = this.awaitPos, oldAwaitIdentPos = this.awaitIdentPos;
        this.initFunction(node2);
        if (this.ecmaVersion >= 6) node2.generator = isGenerator;
        if (this.ecmaVersion >= 8) node2.async = !!isAsync;
        this.yieldPos = 0;
        this.awaitPos = 0;
        this.awaitIdentPos = 0;
        this.enterScope(
          functionFlags2(isAsync, node2.generator) | acornScope.SCOPE_SUPER | (allowDirectSuper ? acornScope.SCOPE_DIRECT_SUPER : 0)
        );
        this.expect(tt.parenL);
      ...
      parseImportSpecifier() {
        ...
        if (isMaybeTypeOnly) {
          ...
          const node2 = super.parseImportSpecifier();
          node2.importKind = "value";
          return node2;
        }
      }
      parseExportSpecifier(exports) {
        ...
        if (!isString && isMaybeTypeOnly) {
          ...
          const node2 = super.parseExportSpecifier(exports);
          node2.exportKind = "value";
          return node2;
        }
      }
      parseTypeOnlyImportExportSpecifier(node2, isImport, isInTypeOnlyImportExport) {
        ...
        if (canParseAsKeyword && this.eatContextual("as")) {
          node2[rightOfAsKey] = isImport ? this.parseIdent() : this.parseModuleExportName();
        }
        if (!node2[rightOfAsKey]) {
          node2[rightOfAsKey] = this.copyNode(node2[leftOfAsKey]);
        }
        if (isImport) {
          this.checkLValSimple(node2[rightOfAsKey], acornScope.BIND_LEXICAL);
        }
      }
  ...
  */
  ...
  ExportNamedDeclaration(node2, state) {
    ...
    if (node2.declaration) {
      ...
      state.write("{");
      const { specifiers } = node2, { length: length2 } = specifiers;
      if (length2 > 0) {
        for (let i = 0; ; ) {
          const specifier = specifiers[i];
  ...
  ArrayExpression: ArrayExpression = function(node2, state) {
    ...
    if (node2.elements.length > 0) {
      const { elements } = node2, { length: length2 } = elements;
      for (let i = 0; ; ) {
  ...
  ObjectExpression(node2, state) {
    ...
    if (node2.properties.length > 0) {
      ...
      const comma = "," + lineEnd;
      const { properties } = node2, { length: length2 } = properties;
      for (let i = 0; ; ) {
  ...
  Literal(node2, state) {
    if (node2.raw != null) {
      ...
      state.write(stringify2(node2.value), node2);
    }
  },
  RegExpLiteral(node2, state) {
    const { regex } = node2;
    state.write(`/${regex.pattern}/${regex.flags}`, node2);
  }
};
var EMPTY_OBJECT = {};
...
var State = class {
  ...
  writeAndMap(code, node2) {
    this.output += code;
    this.map(code, node2);
  }
  writeToStreamAndMap(code, node2) {
    this.output.write(code);
    this.map(code, node2);
  }
  map(code, node2) {
    if (node2 != null) {
      ...
      if (type[0] === "T" && type[8] === "E" || type[0] === "L" && type[1] === "i" && typeof node2.value === "string") {
        const { length: length3 } = code;
        let { column: column2, line: line2 } = this;
    ...
    const { lineEnd } = this;
    if (length2 > 0) {
      if (this.lineEndSize > 0 && (lineEnd.length === 1 ? code[length2 - 1] === lineEnd : code.endsWith(lineEnd))) {
...
// src/plugins/acorn.ts
var TypeScriptParser = Parser.extend(tsPlugin(), (0, import_acorn_jsx.default)());
var loopId = 0;
var tsGenerator = {
  ...baseGenerator,
  ...
  TSAsExpression(node2, state) {
    this[node2.expression.type](node2.expression, state);
  },
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  TSTypeAssertion(node2, state) {
    this[node2.expression.type](node2.expression, state);
  },
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  TSSatisfiesExpression(node2, state) {
    this[node2.expression.type](node2.expression, state);
  },
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  TSNonNullExpression(node2, state) {
    this[node2.expression.type](node2.expression, state);
  },
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  TSInstantiationExpression(node2, state) {
    this[node2.expression.type](node2.expression, state);
  },
  // === Parameter Properties ===
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  TSParameterProperty(node2, state) {
    this[node2.parameter.type](node2.parameter, state);
  },
  // === Other TS-specific nodes ===
  TSExternalModuleReference() {
  },
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  TSQualifiedName(node2, state) {
    this[node2.left.type](node2.left, state);
    state.write(".");
    state.write(node2.right.name);
  },
  TSPropertySignature() {
  },
  TSMethodSignature() {
  ...
  Literal(node2, state) {
    if (typeof node2.value === "string") {
      state.write(JSON.stringify(node2.value));
    } else if (node2.raw !== void 0) {
      state.write(node2.raw);
    } else if (node2.value === null) {
      state.write("null");
    } else {
      state.write(String(node2.value));
    }
  },
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  Identifier(node2, state) {
    state.write(node2.name);
  },
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  FunctionDeclaration(node2, state) {
    if (node2.async) state.write("async ");
    state.write("function");
    if (node2.generator) state.write("*");
    if (node2.id) {
      state.write(" ");
      state.write(node2.id.name);
    }
    formatFunction(node2, state, this);
  },
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  FunctionExpression(node2, state) {
    if (node2.async) state.write("async ");
    state.write("function");
    if (node2.generator) state.write("*");
    if (node2.id) {
  ...
  ArrowFunctionExpression(node2, state) {
    ...
    if (node2.body.type === "BlockStatement") {
      this.BlockStatement(node2.body, state);
    } else {
      const needsParens = node2.body.type === "ObjectExpression";
  ...
  ClassDeclaration(node2, state) {
    ...
    if (node2.superClass) {
      state.write(" extends ");
      this[node2.superClass.type](node2.superClass, state);
    }
    state.write(" ");
    this.ClassBody(node2.body, state);
  },
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  MethodDefinition(node2, state) {
    if (node2.static) state.write("static ");
    if (node2.kind === "get") state.write("get ");
    else if (node2.kind === "set") state.write("set ");
    if (node2.value.async) state.write("async ");
    if (node2.value.generator) state.write("*");
    if (node2.computed) {
      state.write("[");
      this[node2.key.type](node2.key, state);
      state.write("]");
    ...
    formatFunction(node2.value, state, this);
  },
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  PropertyDefinition(node2, state) {
    if (node2.static) state.write("static ");
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  ImportDeclaration(node2, state) {
    if (node2.importKind === "type") return;
    state.write("import ");
    ...
    state.write(JSON.stringify(node2.source.value));
    state.write(";");
  },
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  ExportNamedDeclaration(node2, state) {
    if (node2.exportKind === "type") return;
    state.write("export ");
    if (node2.declaration) {
      this[node2.declaration.type](node2.declaration, state);
    } else {
      state.write("{ ");
      const specifiers = node2.specifiers.filter(
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        (s) => s.exportKind !== "type"
      );
  ...
  ExportAllDeclaration(node2, state) {
    ...
    if (node2.exported) {
      state.write("as ");
      state.write(node2.exported.name);
      state.write(" ");
    }
    state.write("from ");
    state.write(JSON.stringify(node2.source.value));
...
function formatParam(param, state, generator) {
  switch (param.type) {
    case "Identifier":
...
function formatFunction(node2, state, generator) {
  state.write("(");
  const params = node2.params.filter(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
  ...
  state.write(") ");
  generator.BlockStatement(node2.body, state);
}
function parseJSXPragma(code) {
  ...
  if (jsxMatch) {
    return {
      ...
      jsxFragmentPragma: (jsxFragMatch == null ? void 0 : jsxFragMatch[1]) || "Fragment"
    };
  }
  return {
    jsxRuntime: "automatic",
...
var MAX_ITERATIONS = Math.pow(2, 20);
function injectLoopGuards(ast) {
  function walk(node2) {
    if (!node2 || typeof node2 !== "object") return;
    if (node2.type === "ForStatement" || node2.type === "WhileStatement" || node2.type === "DoWhileStatement") {
      const id = loopId++;
      const guardCheck = {
        type: "IfStatement",
        test: {
      ...
      node2.body.body.unshift(guardCheck);
      node2.__loopGuardId = id;
    }
  ...
  walk(ast);
  function wrapLoops(node2) {
    var _a;
    if (!node2 || typeof node2 !== "object") return;
    if (node2.__loopGuardId !== void 0) {
      const id = node2.__loopGuardId;
      delete node2.__loopGuardId;
      const initDecl = {
    ...
    for (const key in node2) {
      ...
      if (Array.isArray(child)) {
        for (let i = child.length - 1; i >= 0; i--) {
          wrapLoops(child[i]);
          if ((_a = child[i]) == null ? void 0 : _a.__loopInitDecl) {
...
function transformJSX(ast, pragma) {
  function walk(node2, parent = null, parentKey = null, parentIndex = null) {
    if (!node2 || typeof node2 !== "object") return;
    if (node2.type === "JSXElement") {
      const transformed = transformJSXElement(node2, pragma);
    ...
    if (node2.type === "JSXFragment") {
      const transformed = transformJSXFragment(node2, pragma);
      if (parent && parentKey !== null) {
        if (parentIndex !== null) {
          parent[parentKey][parentIndex] = transformed;
        } else {
    ...
    for (const key in node2) {
      ...
      if (Array.isArray(child)) {
        for (let i = 0; i < child.length; i++) {
          walk(child[i], node2, key, i);
        }
      } else if (child && typeof child === "object") {
        walk(child, node2, key, null);
      }
    }
  }
  walk(ast);
}
function transformJSXElement(node2, pragma) {
  const openingElement = node2.openingElement;
  ...
  const children = transformJSXChildren(node2.children, pragma);
  if (pragma.jsxRuntime === "automatic") {
        ...
        ...children.length > 0 ? [
          {
            ...
            value: children.length === 1 ? children[0] : { type: "ArrayExpression", elements: children },
            kind: "init",
            method: false,
            shorthand: false,
            computed: false
    ...
    const args = [tag, propsWithChildren];
    if (keyExpr) {
      args.push(keyExpr);
    }
    return {
    ...
    const callee = pragma.jsxPragma.includes(".") ? createMemberExpression(pragma.jsxPragma) : { type: "Identifier", name: pragma.jsxPragma };
    return {
      type: "CallExpression",
      callee,
      arguments: [
        tag,
        propsWithKey.properties.length > 0 ? propsWithKey : { type: "Literal", value: null },
        ...children
      ],
      optional: false
    };
...
function transformJSXFragment(node2, pragma) {
  const children = transformJSXChildren(node2.children, pragma);
  if (pragma.jsxRuntime === "automatic") {
    const jsxFunc = children.length > 1 ? "jsxs" : "jsx";
    const propsWithChildren = {
    ...
    const callee = pragma.jsxPragma.includes(".") ? createMemberExpression(pragma.jsxPragma) : { type: "Identifier", name: pragma.jsxPragma };
    const fragmentId = pragma.jsxFragmentPragma.includes(
      "."
    ) ? createMemberExpression(pragma.jsxFragmentPragma) : { type: "Identifier", name: pragma.jsxFragmentPragma };
    return {
      type: "CallExpression",
      callee,
...
function transformJSXMemberExpression(node2) {
  let object;
  if (node2.object.type === "JSXMemberExpression") {
    object = transformJSXMemberExpression(node2.object);
  } else {
    object = { type: "Identifier", name: node2.object.name };
  }
  return {
    type: "MemberExpression",
    object,
    property: { type: "Identifier", name: node2.property.name },
    computed: false,
    optional: false
  };
}
function transformJSXAttributes(attributes) {
  ...
  for (const attr of attributes) {
    if (attr.type === "JSXSpreadAttribute") {
      ...
      const name = attr.name.type === "JSXIdentifier" ? attr.name.name : attr.name.name;
      let value;
      if (attr.value === null) {
      ...
      const key = /^[a-zA-Z_$][a-zA-Z0-9_$]*$/.test(name) ? { type: "Identifier", name } : { type: "Literal", value: name };
      const property = {
        type: "Property",
        key,
        value,
...
function transformJSXChildren(children, pragma) {
  const result = [];
...
function addJSXRuntimeImport(ast, pragma) {
...
function rewriteBareModuleSpecifiers(ast) {
  function isBareSpecifier(value) {
    return !value.startsWith(".") && !value.startsWith("/") && !value.startsWith("http://") && !value.startsWith("https://");
  }
  function rewrite(value) {
    if (!isBareSpecifier(value)) {
      return value;
    }
    if (value.startsWith("@b9g/crank") || value.startsWith("@b9g/revise") || value.startsWith("@b9g/crankeditable")) {
      return value;
    }
  ...
  function walk(node2) {
    var _a;
    if (!node2 || typeof node2 !== "object") return;
    if (node2.type === "ImportDeclaration" && node2.source) {
      node2.source.value = rewrite(node2.source.value);
    } else if ((node2.type === "ExportNamedDeclaration" || node2.type === "ExportAllDeclaration") && node2.source) {
      node2.source.value = rewrite(node2.source.value);
    } else if (node2.type === "ImportExpression" && ((_a = node2.source) == null ? void 0 : _a.type) === "Literal") {
      node2.source.value = rewrite(node2.source.value);
    }
    for (const key in node2) {
      if (key === "type" || key === "loc" || key === "start" || key === "end")
...
function formatSyntaxError(code, error) {
  var _a, _b;
  const lines = code.split("\n");
  const line2 = ((_a = error.loc) == null ? void 0 : _a.line) ?? 1;
  const column2 = ((_b = error.loc) == null ? void 0 : _b.column) ?? 0;
  const start = Math.max(0, line2 - 3);
  const end = Math.min(lines.length, line2 + 2);
  let result = `SyntaxError: ${error.message}

`;
  for (let i = start; i < end; i++) {
    const lineNum = i + 1;
    const prefix2 = lineNum === line2 ? "> " : "  ";
    const gutter = String(lineNum).padStart(4, " ");
    result += `${prefix2}${gutter} | ${lines[i]}
`;
    if (lineNum === line2) {
      const pointer = " ".repeat(column2) + "^";
      result += `       | ${pointer}
`;
    }
  }
...
// src/components/code-preview.ts
function resolveSpecifiers(code, staticURLs) {
...
${code}`;
    ...
    executePreview = debounce(runPreview, 1500);
    runPreview();
    this.cleanup(() => {
      if (prevScript) {
        prevScript.remove();
  ...
  this.addEventListener("contentchange", (ev) => {
    var _a;
    if (((_a = ev.detail) == null ? void 0 : _a.value) == null) return;
