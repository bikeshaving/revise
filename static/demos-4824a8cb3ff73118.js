    ...
    yield /* @__PURE__ */ createElement(CrankEditable, { state, onstatechange: () => this.refresh() }, /* @__PURE__ */ createElement(
      "div",
      {
        ...
        onkeydown: (ev) => {
          ...
          if (ev.key === "Enter" && todoMatch[2] === "" || ev.key === "Backspace" && pos === lineStart + prefix.length) {
            ev.preventDefault();
            state.setValue(
  ...
  for ({} of this) {
    ...
    yield /* @__PURE__ */ createElement(CrankEditable, { state, onstatechange: () => this.refresh() }, /* @__PURE__ */ createElement("div", { class: "editable", contenteditable: "true", spellcheck: false, hydrate: "!children" }, lines.map((line, lineIndex) => {
      ...
      if (todoMatch) {
        ...
        ), /* @__PURE__ */ createElement("span", { style: checked ? { textDecoration: "line-through", opacity: "0.5" } : void 0 }, todoMatch[2] || /* @__PURE__ */ createElement("br", null)));
      }
      return /* @__PURE__ */ createElement("div", { key }, line || /* @__PURE__ */ createElement("br", null));
    })));
  }
