  ...
  for (let node = _this, descending = true, offset = 0, oldIndex = 0, oldIndexRelative = 0, hasNewline = false; ; node = walker.currentNode) {
    if (descending) {
      ...
      if (nodeInfo.f & IS_VALID) {
        ...
        const beforeText = ((_a = node.getAttribute) == null ? void 0 : _a.call(node, "data-contentbefore")) || "";
    ...
    if (!descending) {
      if (!(nodeInfo.f & IS_VALID)) {
        if (node.nodeType === Node.ELEMENT_NODE && !node.hasAttribute("data-content")) {
      ...
      if (node2.nodeType === Node.ELEMENT_NODE) {
        ...
        if (ni.beforeLength > 0) {
          if (index < ni.beforeLength) {
            return nodeOffsetFromChild(node2, false);
          }
      ...
      "div",
      {
        ...
        onkeydown: (ev) => {
          ...
          if (ev.key === "Enter" && !ev.shiftKey && !ev.ctrlKey && !ev.metaKey) {
            const pos = (_a = state.selection) == null ? void 0 : _a.start;
            const value = state.value;
            console.log("Enter keydown", { pos, sel: state.selection, value: JSON.stringify(value) });
            if (pos != null) {
              const lineStart = value.lastIndexOf("\n", pos - 1) + 1;
              const lineEnd = value.indexOf("\n", pos);
              const line = value.slice(lineStart, lineEnd === -1 ? value.length : lineEnd);
              console.log("line check", { lineStart, lineEnd, line: JSON.stringify(line), match: line === "> " });
              if (line === "> ") {
                ev.preventDefault();
                state.setValue(
...
function* TyporaEditable({ initial }) {
  var _a;
  const state = new EditableState({ value: initial });
  for ({} of this) {
    const lines = state.value.split(/\r\n|\r|\n/);
    ...
    const cursorPos = ((_a = state.selection) == null ? void 0 : _a.start) ?? 0;
    let charCount = 0;
    let cursorLine = 0;
    ...
    let cursor = 0;
    yield /* @__PURE__ */ createElement(CrankEditable, { state, onstatechange: () => this.refresh() }, /* @__PURE__ */ createElement("div", { class: "editable", contenteditable: "true", spellcheck: false, hydrate: "!children" }, lines.map((line, lineIndex) => {
      const key = state.keyer.keyAt(cursor);
      cursor += line.length + 1;
      ...
      if (bqMatch) {
        return /* @__PURE__ */ createElement("div", { key, "data-contentbefore": "> ", style: {
          ...
          color: "var(--text-muted)",
          fontStyle: "italic"
        } }, bqMatch[2] || /* @__PURE__ */ createElement("br", null));
      }
      const headingMatch = line.match(/^(#{1,3} )([\s\S]*)$/);
      if (headingMatch) {
        const level = headingMatch[1].trim().length;
        const fontSize = level === 1 ? "1.5em" : level === 2 ? "1.25em" : "1.1em";
        return /* @__PURE__ */ createElement("div", { key, "data-contentbefore": headingMatch[1], style: {
          fontSize,
          fontWeight: "bold",
          color: "var(--highlight-color)"
        } }, headingMatch[2] || /* @__PURE__ */ createElement("br", null));
      }
      const todoMatch = line.match(/^(- \[[ x]\] )([\s\S]*)$/);
      if (todoMatch) {
        const checked = todoMatch[1] === "- [x] ";
        return /* @__PURE__ */ createElement("div", { key, "data-contentbefore": todoMatch[1], style: {
          paddingLeft: "1.5em"
        } }, /* @__PURE__ */ createElement("span", { "data-content": "", contenteditable: "false", style: {
          display: "inline-block",
          width: "1.5em",
          marginLeft: "-1.5em",
          userSelect: "none"
        } }, checked ? "\u2611" : "\u2610"), /* @__PURE__ */ createElement("span", { style: checked ? { textDecoration: "line-through", opacity: "0.5" } : void 0 }, todoMatch[2] || /* @__PURE__ */ createElement("br", null)));
      }
      return /* @__PURE__ */ createElement("div", { key }, line || /* @__PURE__ */ createElement("br", null));
    })));
  }
