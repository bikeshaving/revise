...
// node_modules/@b9g/revise/src/contentarea.js
init_Buffer();
init_process();

// node_modules/@b9g/revise/src/edit.js
init_Buffer();
init_process();
...
function linkifyText(text) {
  ...
  for (const match of text.matchAll(URL_PATTERN)) {
    ...
    result.push(
      /* @__PURE__ */ createElement("a", { href: match[0], target: "_blank", rel: "noopener", style: { color: "#60a5fa", textDecoration: "underline" } }, match[0])
    );
...
function* LinkifyEditable({ initial }) {
  const state = new EditableState({ value: initial });
  for ({} of this) {
    const lines = state.value.split(/\r\n|\r|\n/);
    if (/(?:\r\n|\r|\n)$/.test(state.value)) {
    ...
    yield /* @__PURE__ */ createElement(CrankEditable, { state, onstatechange: () => this.refresh() }, /* @__PURE__ */ createElement("div", { class: "editable", contenteditable: "true", spellcheck: false }, lines.map((line) => {
      const key = state.keyer.keyAt(cursor);
      cursor += line.length + 1;
      return /* @__PURE__ */ createElement("div", { key }, line ? linkifyText(line) : /* @__PURE__ */ createElement("br", null));
    })));
  }
}
