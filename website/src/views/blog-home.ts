...
export default async function BlogHome({url}: {url: string}) {
	...
	return jsx`
		<${Root} title="Revise.js | Blog" url=${url} description="Articles about Revise.js, contenteditable, and building rich-text editors on the web.">
			<main class=${css`
				max-width: 1200px;
				margin: 0 auto;
